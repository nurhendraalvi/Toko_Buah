...
<!-- LIST PEMBELIAN -->
  ...
  <table border="1" align="center">
    ...
    <tr>
      ...
      ?>
      <td>
        <button><?php echo anchor('c_pembelian/hapus/'.$dt->no_transaksi,'Cancel Pembelian'); ?></button>
      </td>
      <?php
        } else if($akses == '2') {
      ?>
      <td>
        <button><?php echo anchor('c_pembelian/edit/'.$dt->no_transaksi,'Edit Pembelian'); ?></button>
      </td>
      <?php 
        }
      ?>
