...
<!-- LOGIN -->
	<table align="center">
		...
		<tr>
			<td>
				<?php echo $data_pembeli->Nama;?>
			</td>
			<td>
				<?php echo $data_pembeli->Alamat;?>
			</td>
		</tr>
		<?php } ?>
    <tr>
      <td>
        <button><?php echo anchor('c_users/edit/'.$data_pembeli->no_id_pembeli,'Edit'); ?></button>
      </td>
      <td>
        <a href="<?php echo base_url().'index.php/c_pembelian/index'?>"><button>Lihat Data Pembelian</button></a>
      </td>
      <td><a href="<?php echo base_url().'index.php/c_login/logout'?>"><button>Logout</button></a></td>
    </tr>
	</table>
