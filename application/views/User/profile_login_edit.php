...
<div class="container" style="width: 400px">
  <form method="POST" action="<?php echo base_url()."index.php/c_users/update"?>">
   <div class="form-group">
    <input type="hidden" name="id" value="<?php echo $data->no_id_pembeli?>">
    <label for="inputNama">Nama</label>
    <input type="text" class="form-control" id="inputNama" name="name" value="<?php echo $data->Nama?>">
  </div>
  <div class="form-group">
    <label for="inputAlamat">Alamat</label>
    <input type="text" class="form-control" id="inputAlamat" name="address" value="<?php echo $data->Alamat?>">
  </div>
  <div class="form-group">
    <label for="inputEmail">Email</label>
    <input type="text" class="form-control" id="inputEmail" name="email" value="<?php echo $data->username?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="inputNotelp" name="tlp" value="<?php echo $data->no_hp?>">
  </div>
