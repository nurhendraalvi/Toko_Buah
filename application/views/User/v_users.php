...
<div class="container" style="width: 400px">
  <form method="POST" action="<?php echo base_url()."index.php/c_users/simpan_aksi"?>">
   <div class="form-group">
    <label for="inputNama">Nama</label>
    <input type="text" class="form-control" id="inputNama" name="name" placeholder="Masukkan Nama Anda">
  </div>
  <div class="form-group">
    <label for="inputAlamat">Alamat</label>
    <input type="text" class="form-control" id="inputAlamat" name="address" placeholder="Masukkan Alamat Anda">
  </div>
  <div class="form-group">
    <label for="inputEmail">Email</label>
    <input type="text" class="form-control" id="inputEmail" name="email" placeholder="Masukkan Email Anda">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="inputNotelp" name="tlp" placeholder="Masukkan Nomor Telepon Anda">
  </div>
  <div class="form-group">
      <label for="inputAkun">Jenis Akun</label>
  ...
  <button type="submit" name="submit" value="simpan" class="btn btn-primary">Daftar</button>
</form>
</div>
<!-- REGIST -->
