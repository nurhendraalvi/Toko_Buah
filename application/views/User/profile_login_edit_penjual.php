...
<div class="container" style="width: 400px">
  <form method="POST" action="<?php echo base_url()."index.php/c_users/update_penjual"?>">
   <div class="form-group">
    <input type="hidden" name="id" value="<?php echo $data->no_id_penjual?>">
    <label for="inputNama">Nama</label>
    <input type="text" class="form-control" id="inputNama" name="name" value="<?php echo $data->nama_toko?>">
  </div>
  <div class="form-group">
    <label for="inputAlamat">Alamat</label>
    <input type="text" class="form-control" id="inputAlamat" name="address" value="<?php echo $data->alamat_toko?>">
  </div>
  <div class="form-group">
    <label for="inputEmail">Email</label>
    <input type="text" class="form-control" id="inputEmail" name="email" value="<?php echo $data->username_p?>">
  </div>
  <div class="form-group">
    <label for="inputPassword">Password</label>
    <input type="password" class="form-control" id="inputPassword" name="pass" value="<?php echo $data->password?>">
  </div>
  <div class="form-group">
    <label for="inputNotelp">Nomor Telepon</label>
    <input type="number" class="form-control" id="inputNotelp" name="tlp" value="<?php echo $data->no_tlp_toko?>">
  </div>
