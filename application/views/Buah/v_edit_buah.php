...
<div class="container" style="width: 400px">
  <form method="POST" action="<?php echo base_url().'index.php/c_buah/update'?>" enctype="multipart/form-data">
   <div class="form-group">
    <input type="hidden" class="form-control" id="inputKode" name="id_buah" value="<?php echo $data->id_buah?>">
  </div>
  <div class="form-group">
    <label for="inputNamabuah">Nama Buah</label>
    <input type="text" class="form-control" id="inputNamabuah" name="nama_buah" value="<?php echo $data->nama_buah?>">
  </div>
  <div class="form-group">
    <label for="inputJenisbuah">Jenis Buah</label>
    <input type="text" class="form-control" id="inputJenisbuah" name="jenis_buah" value="<?php echo $data->jenis_buah;?>">
  </div>
  <div class="form-group">
    <label for="inputHargabuah">Harga Buah</label>
    <input type="number" class="form-control" id="inputHargabuah" name="harga" value="<?php echo $data->harga;?>">
  </div>
    <div class="form-group">
    <label for="inputStockbuah">Stock Buah</label>
    <input type="number" class="form-control" id="inputStockbuah" name="stock" value="<?php echo $data->stock;?>">
  </div>
