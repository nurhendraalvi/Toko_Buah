...
<!-- LIST BUAH Akun -->
	<table border="1" align="center">
		...
		<tr>
			...
			<td>
				<a href="<?php echo base_url()."index.php/c_buah/index2"; ?>"><button>Detail</button></a>
         <button><?php echo anchor('c_buah/hapus/'.$data->id_buah,'Hapus'); ?></button>
          <button><?php echo anchor('c_buah/edit/'.$data->id_buah,'Edit'); ?></button>
			</td>
		</tr>
		<?php } ?>
	</table>
