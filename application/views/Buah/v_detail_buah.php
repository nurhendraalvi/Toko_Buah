...
<!-- DETAIL BUAH -->
	...
	<table align="center">
    <tr>
      <td><img src="<?php echo base_url('gambar/').$data->nama_file; ?>" width="200px" height="200px"></td>
    </tr>
		<tr>
			<td><?php echo $data->nama_buah;?></td>
		</tr>
		<tr>
			<td><?php echo $data->jenis_buah;?></td>
		</tr>
		<tr>
    ...
    <tr>
      <td><button><?php echo anchor('c_buah/index5/'.$data->id_buah,'Beli');?></button></td>
    </tr>
	</table>
	<?php  }?>
